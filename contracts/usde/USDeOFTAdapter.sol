 ...
 * @notice OFT adapter for USDe vault shares on hub chain (lockbox model)
...
contract USDeOFTAdapter is OFTAdapter {
    /**
     * @notice Creates a new OFT adapter for USDe vault shares
     * @param _token The USDe token address
