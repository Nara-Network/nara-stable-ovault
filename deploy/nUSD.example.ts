...
/**
 * Example deployment script for nUSD and MultiCollateralToken
 *
 * This script demonstrates how to deploy the nUSD OVault system:
 * 1. Deploy MultiCollateralToken (MCT) with initial supported assets
 * 2. Deploy nUSD with MCT as underlying asset
 * 3. Grant MINTER_ROLE to nUSD on MCT
 *
 * To use this script:
 * 1. Rename to nUSD.ts
...
const deployUSDe: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
    ...
    console.log('\n========================================')
    console.log('Deploying nUSD OVault System')
    console.log('========================================\n')
    ...
    console.log('2. Verify MINTER_ROLE was granted to nUSD')
