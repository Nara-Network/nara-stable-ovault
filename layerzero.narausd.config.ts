...
import mainnetConfig from './layerzero-configs/layerzero.narausd.config.mainnet'
import testnetConfig from './layerzero-configs/layerzero.narausd.config.testnet'
