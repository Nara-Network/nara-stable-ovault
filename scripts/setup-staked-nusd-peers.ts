...
async function main() {
    ...
    if (Number(chainId) === 421614) {
        ...
        const adapter = await ethers.getContractAt('StakednUSDOFTAdapter', HUB_STAKED_NUSD_ADAPTER)
        ...
        const oft = await ethers.getContractAt('StakednUSDOFT', SPOKE_STAKED_NUSD_OFT)
